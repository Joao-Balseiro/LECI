public class LigeiroEletrico extends Ligeiro implements VeiculoEletrico {
    ...
    public LigeiroEletrico(String matricula, String marca, String modelo, int potencia, int num, int capBagageira, int autonomia, int carga, String id) {
        super(matricula, marca, modelo, potencia, num, capBagageira, id);
        this.autonomia = autonomia;
        this.carga = carga;
    }
    public LigeiroEletrico(){
    ...
    public boolean equals(Object o){
        if(o == null || this.getClass() != o.getClass())
            return false;
        LigeiroEletrico m = (LigeiroEletrico) o;
